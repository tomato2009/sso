package com.bochtec.ssoserver.controller;

import com.bochtec.ssoserver.util.MockDatabaseUtil;
import com.bochtec.ssoserver.vo.ClientInfoVo;
...
public class SSOServerController {
    ...
    public String checkLogin(String redirectUrl, HttpSession session, Model model, RedirectAttributes redirectAttributes){
        //1.判断是否有全局的会话
     ...
     * @param attributes    重定向数据
     * @return               响应的视图地址
     */
    @RequestMapping("/login")
    public String login(String username, String password, String redirectUrl, HttpSession session, RedirectAttributes attributes){
